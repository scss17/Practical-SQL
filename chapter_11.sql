-- USING DATE PART FUNCTION FOR DIFFERENT TIMEVALUES
SELECT
...
-- EXAMPLES OF CREATING DATE TIME VALUES FROM THEIR COMPONENTS
-- EXAMPLES
...
-- RETRIEVE THE BUSIEST TIME OF DAY
...
-- CALCULATE THE MEDIAN TRIP PER HOUR
SELECT DATE_PART('hour', tpep_pickup_datetime) AS trip_hour,
	   PERCENTILE_CONT(0.5)
